...
"CREATE TABLE [PANIC_BOOK_-_TI] (
	...
	,[Local_NYSP] Text (255)
	,[Local_NYSP_Num] Text (255)
	,[POLICE] Memo
	,[Zone_Stations] Text (255)
...
"CREATE INDEX [Codes_2] ON [PANIC_BOOK_-_TI] ([Station]) "

"CREATE INDEX [ID] ON [PANIC_BOOK_-_TI] ([Station]) "

"CREATE INDEX [Local_Agency1_Num] ON [PANIC_BOOK_-_TI] ([Station]) "

"CREATE INDEX [Local_Agency2_Num] ON [PANIC_BOOK_-_TI] ([Station]) "

"CREATE INDEX [Local_NYSP_Num] ON [PANIC_BOOK_-_TI] ([Station]) "

"CREATE INDEX [ParksID] ON [PANIC_BOOK_-_TI] ([Station]) "
